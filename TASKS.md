...
- [x] Build "Contact" Form (Direct to WhatsApp/Email)

## PHASE 3: LEGAL & POLISH [COMPLETED]
- [x] Add Footer with NIB (Nomor Induk Berusaha) & PT Legal Name.
- [x] SEO Meta Tags (Title, Description).
- [x] Mobile Responsiveness Check (especially the Navbar).
