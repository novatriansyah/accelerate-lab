                ...
                <a href="{{ route('article', $featured) }}"
                    ...
                    <div class="grid lg:grid-cols-2 gap-0">
                        ...
                        <div class="flex flex-col justify-center p-8 lg:p-12 gap-6">
                            ...
                            <h2
                                class="text-3xl font-black leading-tight tracking-tight text-slate-dark dark:text-white group-hover:text-primary transition-colors">
                                {{ $featured->title }}
                            </h2>
                    ...
                    <article
                        ...
                        <div class="flex flex-col flex-1 p-6">
                            ...
                            <a href="{{ route('article', $article) }}" class="block">
                                <h3
                                    class="text-xl font-bold text-slate-dark dark:text-white mb-3 group-hover:text-primary transition-colors">
                                    {{ $article->title }}
                                </h3>
                            </a>
