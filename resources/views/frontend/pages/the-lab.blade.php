...
@section('content')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
            <div class="@container">
                <div class="flex flex-col md:flex-row gap-8 items-center">
                    ...
                    <div
                        class="flex-1 w-full h-[400px] md:h-[500px] rounded-2xl overflow-hidden relative shadow-2xl shadow-primary/10 group">
                        <div
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-bold text-slate-900 dark:text-white">React Server Components v3
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
                <div class="flex flex-col gap-1 border-l-4 border-primary pl-4">
                    ...
                    <p class="text-sm font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wide">Prototypes
                        Built</p>
                </div>
                <div
                    class="flex flex-col gap-1 border-l-4 border-slate-200 dark:border-slate-700 pl-4 hover:border-primary transition-colors duration-300">
                    <p class="text-3xl font-black text-slate-900 dark:text-white tracking-tight">12</p>
                    <p class="text-sm font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wide">Open Source
                        Repos</p>
                </div>
                <div
                    class="flex flex-col gap-1 border-l-4 border-slate-200 dark:border-slate-700 pl-4 hover:border-primary transition-colors duration-300">
                    <p class="text-3xl font-black text-slate-900 dark:text-white tracking-tight">100+</p>
                    <p class="text-sm font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wide">Design Sprints
                    </p>
                </div>
                <div
                    class="flex flex-col gap-1 border-l-4 border-slate-200 dark:border-slate-700 pl-4 hover:border-primary transition-colors duration-300">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                <div class="p-8 md:p-12 flex flex-col justify-center gap-6">
                    ...
                    <p class="text-slate-600 dark:text-slate-300 leading-relaxed text-lg">
                        A retrospective on how we migrated a large-scale fintech application to Next.js App Router,
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="font-mono text-xs text-slate-300 space-y-1">
                            <p><span class="text-purple-400">export</span> <span class="text-blue-400">default</span> <span
                                    class="text-purple-400">async</span> <span class="text-blue-400">function</span> <span
                                    class="text-yellow-300">Page</span>() {</p>
                            <p class="pl-4"><span class="text-purple-400">const</span> data = <span
                                    class="text-purple-400">await</span> <span class="text-blue-400">getData</span>()</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <article
                ...
                <div class="h-48 overflow-hidden relative">
                    ...
                    <img alt="Abstract 3D geometric shapes rendering in cool blue tones"
                        class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-500"
                        data-alt="Abstract 3D geometric shapes rendering in cool blue tones"
                        src="https://lh3.googleusercontent.com/aida-public/AB6AXuDKP6G2A_GGdiczIcZVT6kvFjee9MaTgpkdxOp35qAPukxXKppSLtSvRKC_J3xduRFg-07kDNbx7t8qWUXRF86VR-0gmTDkqrc3_XAejig5rwL6rYq8Y4IUdjtSUkl2bVl6JxqBfI8Yu8RvWgrYMHskMPCKodvuUstptUqLmVxO4nG-ZarF3rzS16KyCayPUwTdzmghb-AjVy9UR8K33u67jdMSx9xkLEZo1wvZ9apZV9DEaCDh09CMYuqHpVBT2J5AdL14t3EqPEQ" />
                </div>
            ...
            <article
                ...
                <div class="h-48 overflow-hidden relative">
                    ...
                    <img alt="UI design sketches and wireframes on a desk with digital devices"
                        class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-500"
                        data-alt="UI design sketches and wireframes on a desk with digital devices"
                        src="https://lh3.googleusercontent.com/aida-public/AB6AXuD-6HO4zGMNzC2dUOxVS3ymm9pyuNEOfaSa6CjmfZEZRBV9Sn9rehwo7QPjwVMSQyj7E3OPAXnPbNPYZs34pjQU3R4qsQDtEJkbveu4Zd1oe46j3Cn92j31r5zNCCP4fNR5Dw5Lyz1sRjVOM31Gg3wG8KGb_nkUYTrr48i-XtjoMyrwO3y2awH5UPssdq1f_0eMhbzeatTqbi8BuXz5JdXDCA3yFKhrWbG7cezFYy9Bbl-smQ_vMUjXEI0rPENSo28mslSxC9bBdD8" />
                </div>
                <div class="p-6 flex flex-col flex-1">
                    <div class="flex justify-between items-center mb-3">
    ...
    <section class="bg-slate-900 py-20 relative overflow-hidden">
        <div
            class="absolute top-0 right-0 w-1/3 h-full bg-gradient-to-l from-primary/20 to-transparent skew-x-12 pointer-events-none">
        </div>
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <p class="text-slate-400 mb-10 max-w-lg mx-auto">Get our latest research, design resources, and engineering
                deep dives delivered straight to your inbox. No spam, just signal.</p>
            <form class="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                <input
                    class="flex-1 h-12 px-4 rounded-lg bg-slate-800 border border-slate-700 text-white placeholder-slate-500 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all"
                    placeholder="Enter your email address" type="email" />
                <button class="h-12 px-8 rounded-lg bg-primary hover:bg-teal-600 text-white font-bold transition-colors"
                    type="button">
                    Subscribe
                </button>
            </form>
