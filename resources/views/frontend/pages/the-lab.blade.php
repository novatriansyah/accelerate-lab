...
<main class="relative z-10 pt-32 pb-24 lg:pt-40 lg:pb-32 overflow-hidden">
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative mb-16 lg:mb-20">
        ...
        <h1 class="text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-slate-900 dark:text-white max-w-5xl mx-auto leading-[1.1] mb-8">
            The Digital <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#00BFA5] via-teal-300 to-[#009688]">Laboratory</span>
        </h1>

        <p class="text-lg sm:text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto leading-relaxed mb-8">
            A showcase of experimental prototypes, telemetry dashboards, and performance benchmark suites built by Accelerate Lab engineers.
        </p>

        <div class="flex items-center justify-center gap-4">
            <a href="{{ url('/case-studies') }}" class="rr-btn rr-btn-primary">
                <span class="btn-wrap">
                    <span class="text-1">View Production Work</span>
                    <span class="text-2">View Production Work</span>
                </span>
            </a>
            <a href="{{ url('/blog') }}" class="rr-btn rr-btn-outline">
                <span class="btn-wrap">
                    <span class="text-1">Read Research Blog</span>
                    <span class="text-2">Read Research Blog</span>
                </span>
            </a>
        </div>
    </section>
