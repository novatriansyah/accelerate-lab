...
<main class="flex-1 flex flex-col items-center w-full">
    ...
    <section class="relative px-4 py-12 md:py-20 lg:py-28 max-w-7xl mx-auto w-full">
        <div class="absolute top-0 right-0 -z-10 w-[600px] h-[600px] bg-primary/5 dark:bg-primary/10 rounded-full blur-3xl opacity-50"></div>
        <div class="flex flex-col gap-10 md:flex-row md:items-center">
            <div class="flex flex-col gap-6 md:w-1/2 lg:pr-12">
                <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100 dark:bg-slate-800 w-fit">
                    ...
                    <span class="text-xs font-semibold uppercase tracking-wider text-text-secondary dark:text-gray-400">Service</span>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4 mt-2">
                    ...
                    <a href="/case-studies" class="flex items-center justify-center h-12 px-6 rounded-lg border border-border-medium dark:border-slate-700 bg-transparent hover:bg-slate-50 dark:hover:bg-slate-800 text-text-main dark:text-white text-base font-semibold transition-colors">
                        View Case Studies
                    </a>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 md:px-10">
            ...
            <div class="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-70 grayscale transition-all duration-500 hover:grayscale-0">
                ...
                <div class="flex items-center gap-2 font-bold text-xl text-slate-700 dark:text-gray-200">
                    <span class="material-symbols-outlined text-3xl">{{ $tech['icon'] }}</span> {{ $tech['name'] }}
                </div>
                @endforeach
            </div>
        </div>
    ...
    <section class="py-16 md:py-24 max-w-7xl mx-auto px-4 md:px-10 w-full">
        <div class="flex flex-col gap-10">
            <div class="flex flex-col gap-4 max-w-2xl">
                ...
                <div class="prose prose-lg prose-slate dark:prose-invert max-w-none text-text-secondary dark:text-gray-300">
                    {!! $service->content !!}
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                ...
                <div class="group flex flex-col gap-4 rounded-xl border border-border-medium dark:border-slate-700 bg-white dark:bg-surface-dark p-6 transition-all hover:shadow-lg hover:border-primary/30">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-text-main dark:text-white mb-2">{{ $feature['title'] }}</h3>
    ...
    <section class="bg-white dark:bg-surface-dark py-16 md:py-24 border-y border-border-light dark:border-slate-800 w-full">
        <div class="max-w-7xl mx-auto px-4 md:px-10">
            <div class="flex flex-col gap-8">
                ...
                <div class="relative pl-4 border-l border-border-medium dark:border-slate-700 space-y-8">
                    ...
                    <div class="relative pl-8">
                        <span class="absolute -left-[21px] top-1 h-2.5 w-2.5 rounded-full bg-primary ring-4 ring-white dark:ring-slate-900"></span>
                        <h3 class="text-lg font-bold text-text-main dark:text-white">{{ $step['title'] }}</h3>
                        <p class="mt-1 text-sm text-text-secondary dark:text-gray-400">{{ $step['description'] }}</p>
                    </div>
                    @endforeach
                </div>
            </div>
