            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
                <div class="lg:col-span-5 flex flex-col gap-10">
                    <div class="flex flex-col gap-4">
                        ...
                        <h1
                            class="text-4xl lg:text-5xl font-black leading-tight tracking-[-0.033em] text-slate-900 dark:text-white font-instrumentsans">
                    ...
                    <div class="flex flex-col gap-6 py-6 border-y border-slate-200/80 dark:border-white/10">
                        <div class="flex items-start gap-4 group">
                            <div
                                class="size-10 rounded-full bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-white/10 flex items-center justify-center text-primary shadow-sm group-hover:scale-110 transition-transform">
                                <x-app-icon name="location_on" class="w-5 h-5" />
                            </div>
                            <div>
                                <h3 class="font-bold text-slate-900 dark:text-white">{{ __('Visit HQ') }}</h3>
                        ...
                        <div class="flex items-start gap-4 group">
                            ...
                            <div>
                                <h3 class="font-bold text-slate-900 dark:text-white">{{ __('Email Us') }}</h3>
                                <a class="text-slate-600 dark:text-slate-400 text-sm mt-1 hover:text-primary transition-colors"
                        ...
                        <div class="flex items-start gap-4 group">
                            ...
                            <div>
                                <h3 class="font-bold text-slate-900 dark:text-white">{{ __('Call Us') }}</h3>
                                <p class="text-slate-600 dark:text-slate-400 text-sm mt-1">
                        ...
                        <div class="flex items-start gap-4 group">
                            ...
                            <div>
                                <h3 class="font-bold text-slate-900 dark:text-white">{{ __('WhatsApp Direct') }}</h3>
                        ...
                        <div class="flex items-start gap-4 group">
                            ...
                            <div>
                                <h3 class="font-bold text-slate-900 dark:text-white">{{ __('Entitas Legal') }}</h3>
                                <p class="text-slate-600 dark:text-slate-400 text-sm mt-1 font-medium">
                    ...
                    <a href="{{ $settings['contact_google_maps_link'] ?? '#' }}" target="_blank" rel="noopener noreferrer"
                        ...
                        <div
                            ...
                            <span class="text-xs font-bold flex items-center gap-1 text-slate-900 dark:text-white">
                                <x-app-icon name="near_me" class="w-3.5 h-3.5 text-primary" />
                                {{ __('Open Maps') }}
                            </span>
                        </div>
                    </a>
                    <div class="rounded-xl border border-slate-200/80 dark:border-white/10 bg-slate-50/80 dark:bg-slate-900/60 p-5 shadow-sm space-y-2">
