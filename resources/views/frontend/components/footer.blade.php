    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            <div class="space-y-4">
                ...
                <div class="flex space-x-4 pt-2">
                    ...
                    <a class="text-slate-400 hover:text-primary transition-colors" href="/the-lab"><i class="material-icons-round text-xl">code</i></a>
                    <a class="text-slate-400 hover:text-primary transition-colors" href="/contact"><i class="material-icons-round text-xl">email</i></a>
                </div>
            </div>
            <div>
                ...
                <ul class="space-y-3 text-sm text-slate-600 dark:text-slate-400">
                    @if(isset($globalServices) && $globalServices->count() > 0)
                        ...
                        <li><a class="hover:text-primary transition-colors" href="{{ route('service', $service) }}">{{ $service->title }}</a></li>
                        @endforeach
                    @else
                        <li><a class="hover:text-primary transition-colors" href="/services">Web Application Dev</a></li>
        ...
        <div class="border-t border-gray-200 dark:border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div class="flex space-x-6 text-xs text-slate-500">
                ...
                <a class="hover:text-slate-800 dark:hover:text-white transition-colors" href="/terms-of-service">Terms of Service</a>
            </div>
        </div>
    </div>
</footer>
