...
<a class="group flex flex-col items-center justify-center border-b-[3px] border-b-primary pb-3 pt-4 px-2" href="/services#strategy">
<p class="text-slate-dark dark:text-white text-sm font-bold tracking-[0.015em]">Product Strategy</p>
</a>
<a class="group flex flex-col items-center justify-center border-b-[3px] border-b-transparent hover:border-b-primary/50 pb-3 pt-4 px-2 transition-colors" href="/services#development">
...
<h2 class="text-3xl md:text-4xl font-bold text-slate-dark dark:text-white">Product Strategy</h2>
</div>
<div class="grid lg:grid-cols-2 gap-12 items-center mb-16">
<div class="flex flex-col gap-6">
<h3 class="text-2xl font-bold text-slate-dark dark:text-white">Turning Chaos into Order</h3>
...
<div>
<h4 class="text-lg font-bold text-slate-dark dark:text-white mb-1">UX/UI Design</h4>
...
<span class="px-3 py-1 bg-white dark:bg-gray-800 rounded-full text-xs font-bold text-slate-dark dark:text-gray-300 border border-slate-200 dark:border-gray-600">Docker</span>
<span class="px-3 py-1 bg-white dark:bg-gray-800 rounded-full text-xs font-bold text-slate-dark dark:text-gray-300 border border-slate-200 dark:border-gray-600">Flutter</span>
</div>
</div>
</div>
</div>
