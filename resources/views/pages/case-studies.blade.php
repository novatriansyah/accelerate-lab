...
<h3 class="text-xl font-bold text-text-main group-hover:text-primary transition-colors">NovaFin App Modernization</h3>
...
<h3 class="text-xl font-bold text-text-main group-hover:text-primary transition-colors">MediGuard AI Portal</h3>
<p class="text-sm text-text-secondary line-clamp-2">
...
<h3 class="text-xl font-bold text-text-main group-hover:text-primary transition-colors">ShopFlow Headless Commerce</h3>
<p class="text-sm text-text-secondary line-clamp-2">
...
<h3 class="text-xl font-bold text-text-main group-hover:text-primary transition-colors">SecureChain Wallet</h3>
<p class="text-sm text-text-secondary line-clamp-2">
...
<h3 class="text-xl font-bold text-text-main group-hover:text-primary transition-colors">UrbanPulse Dashboard</h3>
<p class="text-sm text-text-secondary line-clamp-2">
...
<h3 class="text-xl font-bold text-text-main group-hover:text-primary transition-colors">EduStream LMS</h3>
<p class="text-sm text-text-secondary line-clamp-2">
