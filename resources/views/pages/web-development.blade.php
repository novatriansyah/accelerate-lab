...
<div class="absolute top-0 right-0 -z-10 w-[600px] h-[600px] bg-primary/5 rounded-full blur-3xl opacity-50"></div>
...
<a href="/contact" class="flex items-center justify-center h-12 px-6 rounded-lg bg-primary hover:bg-primary-dark text-white text-base font-bold transition-all shadow-lg shadow-primary/20 group">
                                Start Your Project
...
<div class="relative w-full aspect-square md:aspect-[4/3] rounded-2xl overflow-hidden bg-white dark:bg-surface-dark border border-border-light dark:border-slate-700 shadow-2xl">
<div class="absolute inset-0 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-900 flex items-center justify-center text-border-medium" data-alt="Abstract 3D illustration representing code structure and digital architecture in teal and grey tones">
...
<div class="absolute bottom-6 left-6 right-12 p-4 bg-white/90 dark:bg-surface-dark/90 backdrop-blur-sm rounded-xl border border-border-light dark:border-slate-700 shadow-lg">
...
<div class="h-2 w-full bg-slate-100 dark:bg-slate-700 rounded mb-2"></div>
<div class="h-2 w-2/3 bg-slate-100 dark:bg-slate-700 rounded"></div>
</div>
</div>
</div>
</div>
...
<p class="text-text-secondary text-sm leading-relaxed">
                                            Robust server-side logic using Node.js, Python, or Go. We design efficient databases and microservices that power your business logic.
                                        </p>
</div>
</details>
<details class="group rounded-lg border border-border-medium bg-background-light open:bg-white open:shadow-sm">
...
<div class="px-4 pb-4 pl-[3.25rem]">
<p class="text-text-secondary text-sm leading-relaxed">
                                            Seamless connections between your systems. We build RESTful and GraphQL APIs that are well-documented and secure.
                                        </p>
</div>
</details>
<details class="group rounded-lg border border-border-medium bg-background-light open:bg-white open:shadow-sm">
...
<div class="px-4 pb-4 pl-[3.25rem]">
<p class="text-text-secondary text-sm leading-relaxed">
                                            Cloud-native deployment, serverless computing, and containerization using Docker and Kubernetes for maximum uptime.
                                        </p>
</div>
</details>
</div>
...
<span class="absolute -left-[21px] top-1 h-2.5 w-2.5 rounded-full bg-primary ring-4 ring-white"></span>
<h3 class="text-lg font-bold text-text-main">Discovery &amp; Strategy</h3>
<p class="mt-1 text-sm text-text-secondary">We dive deep into your business goals, user needs, and technical requirements to create a roadmap.</p>
</div>
<div class="relative pl-8">
<span class="absolute -left-[21px] top-1 h-2.5 w-2.5 rounded-full bg-border-medium ring-4 ring-white"></span>
<h3 class="text-lg font-bold text-text-main">Design &amp; Prototyping</h3>
<p class="mt-1 text-sm text-text-secondary">Creating high-fidelity wireframes and interactive prototypes to visualize the end product.</p>
</div>
<div class="relative pl-8">
<span class="absolute -left-[21px] top-1 h-2.5 w-2.5 rounded-full bg-border-medium ring-4 ring-white"></span>
<h3 class="text-lg font-bold text-text-main">Agile Development</h3>
<p class="mt-1 text-sm text-text-secondary">Iterative coding sprints with regular updates, ensuring we build exactly what you need.</p>
</div>
<div class="relative pl-8">
<span class="absolute -left-[21px] top-1 h-2.5 w-2.5 rounded-full bg-border-medium ring-4 ring-white"></span>
<h3 class="text-lg font-bold text-text-main">Launch &amp; Scale</h3>
<p class="mt-1 text-sm text-text-secondary">Rigorous testing, deployment to production, and ongoing support for future growth.</p>
</div>
</div>
</div>
</div>
...
<p class="text-text-secondary text-lg">See how we help industry leaders transform their digital presence.</p>
</div>
<a class="text-primary font-bold hover:text-primary-dark inline-flex items-center gap-1 group" href="/case-studies">
                        View all projects <span class="material-symbols-outlined text-lg group-hover:translate-x-1 transition-transform">arrow_forward</span>
</a>
</div>
...
<div class="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-105" data-alt="Modern fintech dashboard interface screenshot showing graphs and financial data" style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuB95VzzHJTpQ74P4aEkEtZF7y08iKWC9m3_ekcKd3VjBWXUdOiahEWYn9KmnovwvzdrV0XIER5YTRMgj3FRNzK_6ZFwNtNxuBwKDM4SNDPq5BPlT_rkDM3Oy330eNz8VJEztnbAZPhxo0llLLhCvgHAkwh9yUAbv7GRpyhAwILfE3XVTjzTEa7j1nR4udy01JSuAVPJ-UcF2oOrtO7zO3Cf9ELMhoroJDn_On86eHMPpSnbNGqw1JgdPAjRVzcF-FzySdtJgvjVpEM");'></div>
</div>
<div class="flex flex-col gap-2">
<div class="flex gap-2">
<span class="px-2 py-1 bg-background-surface border border-border-medium rounded text-xs font-semibold text-text-secondary">FinTech</span>
<span class="px-2 py-1 bg-background-surface border border-border-medium rounded text-xs font-semibold text-text-secondary">React</span>
</div>
<h3 class="text-xl font-bold text-text-main group-hover:text-primary transition-colors">Nova Financial Platform</h3>
<p class="text-sm text-text-secondary line-clamp-2">Reimagining the investment experience with a high-speed, real-time trading dashboard handling millions of transactions.</p>
</div>
</div>
<div class="group cursor-pointer flex flex-col gap-4">
<div class="w-full aspect-video rounded-xl overflow-hidden bg-border-light relative">
<div class="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-105" data-alt="SaaS analytics platform interface screenshot showcasing data visualization widgets" style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuD0_DrP2wx_9cY2Df8grTID9Hj2MkoGuCG2l1hlglVMZwhCLNnUDkX5VSjD1IA8LAZSRmrkuHv1uX1qk24Nn1NFIZzfYwKnT3ifVemh2EuU9g2wzH9OXvWqEP-Ub5Hc0AgqZKyx9Cx3HFer71pMrAxouYSWYMVuOvm-n0SAtMw0Bmnjh8LchfnjQuemyzBOoCpe-hJFNxLTAs4u9uFJ9NvC-p4xhyxlA9oMgnwwrAG3ltN_FuZpYKJiY4GlTvuXgypBjC8NyXkXilQ");'></div>
</div>
<div class="flex flex-col gap-2">
<div class="flex gap-2">
<span class="px-2 py-1 bg-background-surface border border-border-medium rounded text-xs font-semibold text-text-secondary">SaaS</span>
<span class="px-2 py-1 bg-background-surface border border-border-medium rounded text-xs font-semibold text-text-secondary">Python</span>
</div>
<h3 class="text-xl font-bold text-text-main group-hover:text-primary transition-colors">Orbital Analytics</h3>
<p class="text-sm text-text-secondary line-clamp-2">A scalable data analytics tool for enterprise marketing teams, featuring automated reporting and AI insights.</p>
</div>
</div>
</div>
</section>
...
<div class="absolute right-[-100px] top-[-100px] w-[300px] h-[300px] rounded-full bg-white blur-3xl"></div>
<div class="absolute left-[-100px] bottom-[-100px] w-[300px] h-[300px] rounded-full bg-black blur-3xl"></div>
</div>
<div class="relative z-10 flex flex-col items-center gap-6 max-w-2xl mx-auto">
<h2 class="text-3xl md:text-5xl font-black text-white leading-tight">Ready to Accelerate Your Digital Growth?</h2>
<p class="text-white/90 text-lg">Let's build something extraordinary together. Schedule a free consultation with our engineering team.</p>
<a href="/contact" class="mt-4 bg-white text-primary hover:bg-slate-50 font-bold py-4 px-8 rounded-lg shadow-xl shadow-black/10 transition-transform active:scale-95 text-lg">
                            Book a Consultation
                        </a>
</div>
</div>
